...
# ==============================================================================
questions = [
# Lista de 100 preguntas de filosofía en formato de Respuesta Corta (q, a, keywords, context)
preguntas_filosofia = [
    ...
    {"q": "¿Qué aspecto de la acción es el foco de la Ética de la Virtud de Aristóteles?",
